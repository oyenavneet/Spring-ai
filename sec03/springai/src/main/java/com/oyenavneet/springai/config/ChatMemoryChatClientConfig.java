package com.oyenavneet.springai.config;
...
public class ChatMemoryChatClientConfig {
    ...
    //Build custom Bean of Chat memory to configure own properties like maxMessage.
    @Bean
    ...
    public ChatClient chatClient(ChatClient.Builder chatClientBuilder,
        ...
        return chatClientBuilder
                .defaultAdvisors(List.of(loggerAdvisor, memoryAdvisor, tokenUsageAuditAdvisor, retrievalAugmentationAdvisor))
                .build();
    }
